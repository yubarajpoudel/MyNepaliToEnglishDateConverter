...
s.summary = "This is the simple library that let you to convert the nepali date in the english and vice-versa. This is build in swift 2.2 and may not work in the higher version."
s.requires_arc = true
...
# 8
s.source_files = "NepaliToEnglishDateConverter/converter/*.{swift}"
